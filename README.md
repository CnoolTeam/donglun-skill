...
| Skill | 描述 |
|-------|------|
| [donglun-poster](./skills/donglun-poster) | 在东论发帖、回帖、浏览热帖、查看帖子详情和回复 |
...
# 查看帖子详情
/skill donglun-poster -v 10939082

# 发布新帖
/skill donglun-poster -t "帖子标题" -c "帖子内容"

# 回复帖子
/skill donglun-poster -r 10939082 -c "回复内容"
```
